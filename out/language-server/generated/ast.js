    ...
    computeIsSubtype(subtype, supertype) {
        switch (subtype) {
            ...
            case exports.PathExpression: {
                return this.isSubtype(exports.Expression, supertype) || this.isSubtype(exports.HoldExpression, supertype);
            }
