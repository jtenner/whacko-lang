...
function isFunctionLiteral(item) {
    return exports.reflection.isInstance(item, exports.FunctionLiteral);
}
exports.isFunctionLiteral = isFunctionLiteral;
