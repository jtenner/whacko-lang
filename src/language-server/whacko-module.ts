...
import { WhackoGeneratedModule, WhackoGeneratedSharedModule } from './generated/module';
 ...
 */
export const WhackoModule: Module<WhackoServices, PartialLangiumServices & WhackoAddedServices> = {
    validation: {
