...
export type PathExpression = ArrayAccessExpression | CallExpression | MemberAccessExpression | PrimaryExpression;
...
export interface BinaryExpression extends AstNode {
    ...
    lhs: BitShiftExpression | BitwiseAndExpression | BitwiseOrExpression | BitwiseXOrExpression | ComaprisonExpression | EqualityExpression | ExponentiationExpression | LeftUnaryExpression | LogicalAndExpression | LogicalOrExpression | ProductExpression | SumExpression
    op: '!=' | '%' | '%=' | '&&' | '&&=' | '&' | '&=' | '*' | '**' | '**=' | '*=' | '+' | '+=' | '-' | '-=' | '/' | '/=' | '<' | '<<' | '<<=' | '<=' | '=' | '==' | '>' | '>=' | '>>' | '>>=' | '>>>=' | '??=' | '^' | '^=' | '|' | '|=' | '||' | '||='
...
export interface LeftUnaryExpression extends AstNode {
    readonly $container: ArrayAccessExpression | AwaitExpression | BinaryExpression | CallExpression | ClassDeclaration | DeclareDeclaration | ExportDeclarator | ExpressionStatement | FieldClassMember | FunctionDeclaration | GetterClassMember | GrabStatement | GroupLiteral | HoldExpression | IfElseStatement | ImportDeclarator | LeftUnaryExpression | MemberAccessExpression | MethodClassMember | NamedTypeExpression | NamespaceDeclaration | NewExpression | Parameter | PathTypeExpression | ReturnStatement | SetterClassMember | TernaryExpression | TupleExpression | TypeDeclaration | TypeDeclarationStatement | VariableDeclarator | WhileStatement | YieldExpression;
    readonly $type: 'ArrayAccessExpression' | 'AsyncBlockLiteral' | 'AwaitExpression' | 'BinaryLiteral' | 'CallExpression' | 'FalseLiteral' | 'FloatLiteral' | 'FunctionLiteral' | 'GroupLiteral' | 'HexLiteral' | 'HoldExpression' | 'ID' | 'IntegerLiteral' | 'LeftUnaryExpression' | 'MemberAccessExpression' | 'NewExpression' | 'NullLiteral' | 'OctalLiteral' | 'PathExpression' | 'PrimaryExpression' | 'StringLiteral' | 'SuperLiteral' | 'ThisLiteral' | 'TrueLiteral';
...
export interface NamespaceDeclaration extends AstNode {
    ...
    declarations: Array<ClassDeclaration> | Array<DeclareDeclaration> | Array<FunctionDeclaration> | Array<NamespaceDeclaration> | Array<TypeDeclaration>
    export: boolean
...
export function isPathTypeExpression(item: unknown): item is PathTypeExpression {
...
export interface AwaitExpression extends LeftUnaryExpression {
    readonly $container: ArrayAccessExpression | AwaitExpression | BinaryExpression | CallExpression | ClassDeclaration | DeclareDeclaration | ExportDeclarator | ExpressionStatement | FieldClassMember | FunctionDeclaration | GetterClassMember | GrabStatement | GroupLiteral | HoldExpression | IfElseStatement | ImportDeclarator | LeftUnaryExpression | MemberAccessExpression | MethodClassMember | NamedTypeExpression | NamespaceDeclaration | NewExpression | Parameter | PathTypeExpression | ReturnStatement | SetterClassMember | TernaryExpression | TupleExpression | TypeDeclaration | TypeDeclarationStatement | VariableDeclarator | WhileStatement | YieldExpression;
    readonly $type: 'ArrayAccessExpression' | 'AsyncBlockLiteral' | 'AwaitExpression' | 'BinaryLiteral' | 'CallExpression' | 'FalseLiteral' | 'FloatLiteral' | 'FunctionLiteral' | 'GroupLiteral' | 'HexLiteral' | 'HoldExpression' | 'ID' | 'IntegerLiteral' | 'MemberAccessExpression' | 'NewExpression' | 'NullLiteral' | 'OctalLiteral' | 'PathExpression' | 'PrimaryExpression' | 'StringLiteral' | 'SuperLiteral' | 'ThisLiteral' | 'TrueLiteral';
    expression: LeftUnaryExpression
}
...
export interface HoldExpression extends AwaitExpression {
    readonly $container: ArrayAccessExpression | AwaitExpression | BinaryExpression | CallExpression | ClassDeclaration | DeclareDeclaration | ExportDeclarator | ExpressionStatement | FieldClassMember | FunctionDeclaration | GetterClassMember | GrabStatement | GroupLiteral | HoldExpression | IfElseStatement | ImportDeclarator | LeftUnaryExpression | MemberAccessExpression | MethodClassMember | NamedTypeExpression | NamespaceDeclaration | NewExpression | Parameter | PathTypeExpression | ReturnStatement | SetterClassMember | TernaryExpression | TupleExpression | TypeDeclaration | TypeDeclarationStatement | VariableDeclarator | WhileStatement | YieldExpression;
    readonly $type: 'ArrayAccessExpression' | 'AsyncBlockLiteral' | 'BinaryLiteral' | 'CallExpression' | 'FalseLiteral' | 'FloatLiteral' | 'FunctionLiteral' | 'GroupLiteral' | 'HexLiteral' | 'HoldExpression' | 'ID' | 'IntegerLiteral' | 'MemberAccessExpression' | 'NewExpression' | 'NullLiteral' | 'OctalLiteral' | 'PathExpression' | 'PrimaryExpression' | 'StringLiteral' | 'SuperLiteral' | 'ThisLiteral' | 'TrueLiteral';
    expression: LeftUnaryExpression
}
...
export interface NewExpression extends HoldExpression {
    readonly $container: ArrayAccessExpression | AwaitExpression | BinaryExpression | CallExpression | ClassDeclaration | DeclareDeclaration | ExportDeclarator | ExpressionStatement | FieldClassMember | FunctionDeclaration | GetterClassMember | GrabStatement | GroupLiteral | HoldExpression | IfElseStatement | ImportDeclarator | LeftUnaryExpression | MemberAccessExpression | MethodClassMember | NamedTypeExpression | NamespaceDeclaration | NewExpression | Parameter | PathTypeExpression | ReturnStatement | SetterClassMember | TernaryExpression | TupleExpression | TypeDeclaration | TypeDeclarationStatement | VariableDeclarator | WhileStatement | YieldExpression;
    readonly $type: 'ArrayAccessExpression' | 'AsyncBlockLiteral' | 'BinaryLiteral' | 'CallExpression' | 'FalseLiteral' | 'FloatLiteral' | 'FunctionLiteral' | 'GroupLiteral' | 'HexLiteral' | 'ID' | 'IntegerLiteral' | 'MemberAccessExpression' | 'NewExpression' | 'NullLiteral' | 'OctalLiteral' | 'PathExpression' | 'PrimaryExpression' | 'StringLiteral' | 'SuperLiteral' | 'ThisLiteral' | 'TrueLiteral';
...
export class WhackoAstReflection extends AbstractAstReflection {
    ...
    protected override computeIsSubtype(subtype: string, supertype: string): boolean {
        switch (subtype) {
            ...
            case ID: {
                return this.isSubtype(PathTypeExpression, supertype) || this.isSubtype(PrimaryExpression, supertype);
            }
